...
//
#include <OneWire.h>                  // cf. https://www.maximintegrated.com/en/products/1-wire/flash/overview/index.cfm
...
void loop(void)
{
  ...
  if (millis() - lastTempRequest >= delayInMillis)          // waited long enough??
  {
    ...
    resolution  = sensors.getResolution(tempDeviceAddress); // DS18B20 resultions (9, 10,11,12 bits)...
